...
//   const { data: ridesData, isLoading: ridesIsLoading } =
//     useGetAllRidesQuery(undefined);
//   // console.log(ridesData?.data);

//   const { data: driverData, isLoading: driverIsLoading } =
//     useGetAllDriversQuery({ limit: 1000, fields: "_id,name" });
//   console.log(driverData);

//   const ridesOption = ridesData?.data?.map(
//     (item: { _id: string; rider: string }) => ({
//       label: item.rider,
//       value: item._id,
//     })
//   );

//   const driverOptions = driverData?.data?.map(
//     (item: { user: any; _id: string; name: string }) => ({
...
//         <Select
//           onValueChange={(value) => handleRideChange(value)}
//           value={selectedRides ? selectedRides : ""}
//           disabled={ridesIsLoading}
//         >
...
//           value={selectedDrivers ? selectedDrivers : ""}
//           disabled={driverIsLoading}
//         >
//           <SelectTrigger className="w-full">
//             <SelectValue />
//           </SelectTrigger>
